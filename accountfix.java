...
public class accountfix extends JFrame implements ActionListener {
	private static final long serialVersionUID = 1L;

	Function fun = new Function();

	JLabel lb1 = new JLabel("當前是修改頁面");
	JLabel lb2 = new JLabel("提示：登入前請先輸入學號，修改、刪除根據學號修改信息\n");
	...
	public accountfix() {
		...
		Search = new JButton("查看我的學生資訊");
		Fix = new JButton("修改學生信息");
		Show = new JButton("顯示全部學生資訊");
		Back = new JButton("返回");
		...
		Search.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					fw = new FileWriter("D:\\Student1.txt");
		...
		Fix.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (flag == -1) {
					...
					JOptionPane.showMessageDialog(null, "該系统中存在數據\n\n,確認返回後請輸入需要修改後的數據");
